...
export const MENU_CATS = {
  ...
  empanizados: {
    ...
    items: [
      ...
      { nombre: "Chimmy Roll",       desc: "Salsa de anguila y tampico por fuera, por dentro: salami, carne molida y tocino.",         precio: "$95", foto: "/chimmy-roll.jpg", popular: true },
      ...
      { nombre: "Burguer Roll",      desc: "Aderezo BBQ por fuera, por dentro: carne molida, queso manchego y tocino.",               precio: "$95", foto: "/IMG_7047.jpg", popular: true },
