...
const SOCIAL = [
  { href: "https://instagram.com/makinorimx",  label: "Instagram" },
  { href: "https://facebook.com",              label: "Facebook"  },
  { href: "https://wa.me/527331002030",         label: "WhatsApp"  },
];
      ...
      <div style={{ padding: "64px 40px 40px", maxWidth: 1200, margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr", gap: 48, flexWrap: "wrap" }}>
          ...
          <div>
            ...
            <div style={{ display: "flex", gap: 12 }}>
              {SOCIAL.map(({ href, label }) => (
                <SocialBtn key={href} href={href}>{label}</SocialBtn>
              ))}
            </div>
          </div>
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              <FooterLink href="tel:+527331002030">+52 733 100 2030</FooterLink>
              <FooterLink href="mailto:hola@makinori.mx">hola@makinori.mx</FooterLink>
              <FooterLink href="https://wa.me/527331002030">WhatsApp directo →</FooterLink>
            </div>
