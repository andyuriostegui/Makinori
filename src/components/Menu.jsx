      ...
      <Container max={800}>
        <div style={{ textAlign: "center", marginBottom: 56 }}>
          ...
          <h2 style={{
            ...
            Menú <span style={{ color: C.coral }}>Completo</span>
          </h2>
        </div>
        ...
        <div style={{ marginBottom: 24 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 4 }}>
            <span style={{ fontFamily: "Noto Serif JP, serif", fontSize: 12, color: C.coral, letterSpacing: "0.15em" }}>{data.jp}</span>
